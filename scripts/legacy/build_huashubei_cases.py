"""DEPRECATED (v2.8.0): 一次性烘焙脚本已退役并移入 scripts/legacy/，仅保留复核用，
不得再生成统计真值；重建要点见 scripts/README.md "历史重建配方" 节。
...
SKILL_ROOT = Path(__file__).resolve().parents[2]  # scripts/legacy/ -> skill 根
