% SEED v0.1 — 电工杯论文 LaTeX 模板 (基于 ctex article)
% 用法: 由 scripts/render_paper.py --competition diangong 调用
% 编译: xelatex main.tex (三编, 中文必须 xelatex)
% 电工杯无官方模板, 本模板按工程类常见排版习惯组织
